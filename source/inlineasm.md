...
When the [Fil-C compiler](compiler.html)'s safety instrumentation pass (called `FilPizlonator`) runs, inline assembly is present in LLVM IR as a pair of strings:
...
Please read [T800.txt](https://github.com/pizlonator/fil-c/blob/041d1500b8d80ff753127ede1be6d0687a2d13ef/T800.txt), [README.md](https://github.com/pizlonator/fil-c/blob/1aa7e99e92667f007872912846d12924415b30be/README.md), and [https://fil-c.org/how](https://fil-c.org/how) to understand the context of what we're doing.
...
It would be great to support any inline assembly that meets these criteria. To do that, we need to integrate the following into [`llvm/lib/Transforms/Instrumentation/FilPizlonator.cpp`](https://github.com/pizlonator/fil-c/blob/deluge/llvm/lib/Transforms/Instrumentation/FilPizlonator.cpp)'s handleInlineAsm function:
...
As far as I know, Fil-C has the first ever implementation of memory-safe X86_64 inline assembly. It supports hundreds of instructions, including useful x87, SIMD, bitmath, flags management, and fence instructions. Basically anything that is safe within the Fil-C [garage-in, memory safety out](gimso.html) model.
