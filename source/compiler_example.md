...
**NOTE: This document is based on an old version of Fil-C -- version 0.668.3. Hence, it shows an machine code for an older version of the Fil-C calling convention. However, this document is otherwise still accurate and it's still a great place to start for understanding code generated by the Fil-C compiler.**
