...
**NOTE: This document is based on an old version of Fil-C - version 0.668.3. Hence, it shows machine code that is subtly different from what the Fil-C compiler will emit today. The biggest change is [the calling convention](calling_convention.html); at the time this document was written, Fil-C only used the generic calling convention and had no signature specialization. However, this document is still a good place to start for understanding code generated by the Fil-C compiler.**
...
- [Issue 22: The Fil-C calling convention should be optimized](https://github.com/pizlonator/fil-c/issues/22) - *fixed, see [Fil-C calling convention](calling_convention.html).*

- [Issue 23: Turn malloc calls into direct calls into the GC allocator](https://github.com/pizlonator/fil-c/issues/23) - *[fixed](https://github.com/pizlonator/fil-c/commit/203217b9889fe).*
